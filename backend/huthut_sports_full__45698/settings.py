"""
Django settings for huthut_sports_full__45698 project.
...
ROOT_URLCONF = 'huthut_sports_full__45698.urls'
...
WSGI_APPLICATION = 'huthut_sports_full__45698.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "huthut_sports_full__45698 API",
    "DESCRIPTION": "API documentation for huthut_sports_full__45698 App",
    "VERSION": "v1",
}
